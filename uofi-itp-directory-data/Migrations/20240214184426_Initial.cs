        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInternalOnly = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OfficeSettingsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offices_OfficeSettings_OfficeSettingsId",
                        column: x => x.OfficeSettingsId,
                        principalTable: "OfficeSettings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AreaId", "CanEditAllPeopleInUnit", "IsActive", "IsFullAdmin", "LastUpdated", "ListedNameFirst", "ListedNameLast", "NetId", "OfficeId" },
                values: new object[,]
                {
                    { -2, null, true, true, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "", "rbwatson@illinois.edu", null },
                    { -1, null, true, true, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "", "jonker@illinois.edu", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offices_OfficeSettingsId",
                table: "Offices",
                column: "OfficeSettingsId");
